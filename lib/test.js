...
const stackUtils = require('./stack.js')
...
class Test extends Base {
  ...
  sub (Class, extra, caller) {
    ...
    extra.parent = this
    extra.stack = stackUtils.instance.captureString(80, caller)
  ...
  printResult (ok, message, extra, front) {
    ...
    if (hasOwn(extra, 'stack') && !hasOwn(extra, 'at'))
      extra.at = stackUtils.instance.parseLine(extra.stack.split('\n')[0])

    if (!ok && !extra.skip && !hasOwn(extra, 'at')) {
      assert.equal(typeof fn, 'function')
      extra.at = stackUtils.instance.at(fn)
      if (!extra.todo)
        extra.stack = stackUtils.instance.captureString(80, fn)
    }
  ...
  emits (emitter, event, message, extra) {
    ...
    extra.at = stackUtils.instance.at(Test.prototype.emits)
    extra.stack = stackUtils.instance.captureString(80, Test.prototype.emits)
  ...
  rejects (...args) {
    ...
    extra.at = stackUtils.instance.at(this.currentAssert)
